                ...
                <article class="rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 ">
                    ...
                    <div class="mt-1 p-2">
                        ...
                        <div class="mt-3 flex items-end justify-between">
                            ...
                            @if ($tool->contract)
                            <livewire:pastille :color="$tool->contract->color" class="px-4 py-1 font-bold text-sm grid grids-col1"> 
                                <span>Unité {{ $tool->contract->unit }}&euro;</span>
                                <span>Forfait {{ $tool->contract->flat_rate }}&euro;</span>
                            </livewire:pastille>
                            @endif
                            <p class="text-sm font-bold text-blue-500">{{ $tool->number }} en stock</p>
                        </div>
                    </div>
                    </a>
                </article>
